...
apt-get install --yes --auto-remove --no-install-recommends build-essential tini coreutils findutils git tree jq git htop vim ripgrep curl gnupg perf strace psmisc iputils-ping tcpdump traceroute
